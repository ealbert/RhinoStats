...
class PlayerRepository(object):
    ...
    def get_player(cls, connection, clan_id, account_id):
        sql = """
                SELECT
                    clan_id, account_id, account_name, total_resources_earned, stronghold_defense_battles,
                    stronghold_skirmish_battles, seven_day_resources_earned, thirty_day_resources_earned,
    ...
    @classmethod
    def get_total_resources_at_date(cls, connection, clan_id, account_id, from_date):
        sql = """
            SELECT total_resources_earned
